        ...
        {seeDetailIsOn ? (
          <div className="w-4/5 mx-auto">
            ...
            <div className="flex flex-row justify-center space-x-40">
              <div
                className="transition duration-300 ease-out relative w-36 h-40 rounded-xl bg-gray-500 text-white hover:bg-gray-900 flex flex-col hover:flex-row item-center justify-center text-center"
                onMouseEnter={() => {
              ...
              >
                ...
                {showAbsoluteClass && showId === "1" && (
                  <div className="absolute transition duration-150 ease-in top-1/2 h-20 w-full border-t border-dashed border-black bg-slate-500 rounded-b-xl flex flex-col item-center justify-center cursor-pointer">
                    <p className="">View</p>
                  </div>
                )}
              </div>
